                            ...
                            <div className="mt-3 pt-3 border-t border-slate-100 dark:border-slate-800 animate-in slide-in-from-top-2 print:block print:border-black/20" onClick={(e) => e.stopPropagation()}>
                              ...
                              <div className="flex items-center gap-1.5 mb-2 mt-[-2px] print:hidden bg-slate-50 dark:bg-slate-900/50 px-2 py-1.5 rounded-md border border-slate-100 dark:border-slate-800">
                                ...
                                <div className="flex flex-col gap-2 mt-2 print:hidden">
                                  <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center justify-between gap-3 sm:gap-2 bg-slate-50 dark:bg-slate-900/50 p-2.5 sm:p-2 rounded-lg border border-slate-100 dark:border-slate-800">
                                    ...
                                    {/* QC & MAX */}
                                    <div className="flex items-center justify-between sm:justify-start gap-1.5 shrink-0 pt-2 sm:pt-0 border-t sm:border-t-0 border-slate-200 dark:border-slate-700">
                                      <label htmlFor={`qc-${key}`} className="flex items-center gap-1 text-[9px] font-medium text-slate-600 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-2 py-1.5 sm:px-1.5 sm:py-1 rounded cursor-pointer hover:bg-slate-50 shadow-sm transition-colors" title="Menandakan bahwa produk telah dicek sesuai standar sebelum dipindahkan ke Packing.">
                                        <input 
                                          type="checkbox" 
                                          id={`qc-${key}`}
